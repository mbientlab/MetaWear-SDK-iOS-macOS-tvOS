...
@interface MBLRMSAccelerometerData ()
...
{
    return [NSString stringWithFormat:@"%@ %f", [super description], self.rms];
}

- (NSString *)csvRepresentation
{
    return [NSString stringWithFormat:@"%f,%f\n", self.timestamp.timeIntervalSince1970, self.rms];
}
