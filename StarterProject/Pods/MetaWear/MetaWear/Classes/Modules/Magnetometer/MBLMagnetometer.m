...
@interface MBLMagnetometer ()
@property (nonatomic) MBLData *magneticField;
@end

@implementation MBLMagnetometer
@synthesize magneticField = _noencode_magneticField; // TODO: Once we implement magneticField we can remove this

+ (instancetype)objectWithDevice:(MBLMetaWear *)device moduleInfo:(MBLModuleInfo *)moduleInfo
{
    return [[MBLMagnetometerBMM150 alloc] initWithDevice:device moduleInfo:moduleInfo];
}
