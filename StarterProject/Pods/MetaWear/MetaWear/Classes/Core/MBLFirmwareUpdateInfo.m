...
@interface MBLFirmwareUpdateInfo ()
@property (nonatomic) NSURL *firmwareUrl;
@property (nonatomic) CBPeripheral *target;
@property (nonatomic) CBCentralManager *centralManager;
@end

@implementation MBLFirmwareUpdateInfo

- (instancetype)initWithFirmwareUrl:(NSURL *)firmwareUrl
                             target:(CBPeripheral *)target
