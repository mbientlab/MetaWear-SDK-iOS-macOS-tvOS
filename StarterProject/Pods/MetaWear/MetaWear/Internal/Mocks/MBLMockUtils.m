...
@implementation MBLMockUtils

+ (NSMutableData *)dataFromString:(NSString *)data
{
    NSArray *bytes = [data componentsSeparatedByString:@"-"];
...
+ (NSMutableString *)stringFromData:(NSData *)data
{
