/**
 * MBLAccelerometerBoschPackedDataReadyEvent.m
 * MetaWear
 *
...
@implementation MBLAccelerometerBoschPackedDataReadyEvent

- (instancetype)initWithAccelerometer:(MBLAccelerometerBosch *)accelerometer
{
    self = [super initWithModule:accelerometer registerId:0x1C format:[[MBLAccelerometerBoschFormat alloc] initWithAccelerometer:accelerometer packed:YES]];
    if (self) {
    }
    return self;
}
