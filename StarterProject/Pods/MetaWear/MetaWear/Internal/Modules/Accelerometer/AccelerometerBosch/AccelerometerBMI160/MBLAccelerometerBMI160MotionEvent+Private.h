/**
 * MBLAccelerometerBMI160MotionEvent+Private.h
 * MetaWear
 *
 * Created by Stephen Schiffli on 1/28/16.
...
@class MBLAccelerometerBMI160;

@interface MBLAccelerometerBMI160MotionEvent (Private)
