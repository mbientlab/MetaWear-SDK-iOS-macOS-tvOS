...
@interface MBLTemperature (Private)
@property (nonatomic) NSArray *channels;
@property (nonatomic) MBLData<MBLNumericData *> *onDieThermistor;
@property (nonatomic, nullable) MBLExternalThermistor *externalThermistor;
@property (nonatomic, nullable) MBLData *onboardThermistor;


@property (nonatomic, nullable) MBLRegister *thermistorSettings;
