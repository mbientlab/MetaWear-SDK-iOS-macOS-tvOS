...
@interface MBLEntityModule (Private)

@property (nonatomic) int activeNotifications;
@property (nonatomic) NSMutableArray *entities;
@property (nonatomic) int maxEntities;

@property (nonatomic, nullable) MBLRegister *addEntity;
@property (nonatomic, nullable) MBLRegister *removeEntity;
@property (nonatomic, nullable) MBLRegister *activateEntity;
@property (nonatomic, nullable) MBLRegister *deactivateEntity;

@property (nonatomic, nullable) MBLRegister *globalNotifications;
@property (nonatomic, nullable) MBLRegister *notificationEnable;
