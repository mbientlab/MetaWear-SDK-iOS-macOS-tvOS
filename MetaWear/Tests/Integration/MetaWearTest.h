...
@property (nonatomic) BOOL disconnectAtEnd;

@property (nonatomic) uint8_t i2cDevice;
@property (nonatomic) uint8_t i2cReadOnlyReg;
@property (nonatomic) uint8_t i2cReadOnlyRegValue;
@property (nonatomic) uint8_t i2cScratchReg;
@property (nonatomic) uint8_t i2cScratchRegValue;
