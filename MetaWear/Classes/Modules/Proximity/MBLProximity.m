...
@interface MBLProximity ()
@property (nonatomic) MBLData *proximity;
@end

@implementation MBLProximity

+ (instancetype)objectWithDevice:(MBLMetaWear *)device moduleInfo:(MBLModuleInfo *)moduleInfo
{
    return [[MBLProximityTSL2671 alloc] initWithDevice:device moduleInfo:moduleInfo];
}
