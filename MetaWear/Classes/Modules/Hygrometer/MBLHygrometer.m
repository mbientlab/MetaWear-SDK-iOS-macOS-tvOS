...
@interface MBLHygrometer ()
@property (nonatomic) MBLData *humidity;
@end

@implementation MBLHygrometer

+ (instancetype)objectWithDevice:(MBLMetaWear *)device moduleInfo:(MBLModuleInfo *)moduleInfo
{
    return [[MBLHygrometerBME280 alloc] initWithDevice:device moduleInfo:moduleInfo];
}
