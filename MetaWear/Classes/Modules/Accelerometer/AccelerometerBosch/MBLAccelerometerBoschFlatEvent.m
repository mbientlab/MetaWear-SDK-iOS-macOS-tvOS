...
{
    self = [super initWithModule:accelerometer registerId:0x14 format:[[MBLAccelerometerBoschFlatFormat alloc] initWithAccelerometer:accelerometer] identifier:@"bosch-flat"];
    if (self) {
