...
{
    return [NSString stringWithFormat:@"%@ %@", [super description], self.value.stringValue];
}

- (NSString *)csvRepresentation
{
    return [NSString stringWithFormat:@"%f,%@\n", self.timestamp.timeIntervalSince1970, self.value.stringValue];
}
