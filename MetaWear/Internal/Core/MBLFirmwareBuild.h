...
@interface MBLFirmwareBuild : NSObject
...
@property (nonatomic, readonly, nullable) NSString *modelNumber;
@property (nonatomic, readonly, nullable) NSString *buildFlavor;
@property (nonatomic, readonly, nullable) NSString *firmwareRev;
