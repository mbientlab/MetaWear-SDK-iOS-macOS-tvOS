/**
 * MBLBarometerBoschPeriodicAltitudeEvent.m
 * MetaWear
 *
 * Created by Stephen Schiffli on 7/23/15.
...
@interface MBLBarometerBoschPeriodicAltitudeEvent ()
@property (nonatomic) MBLRegister *cyclicEnable;
@end

@implementation MBLBarometerBoschPeriodicAltitudeEvent

- (instancetype)initWithBarometer:(MBLBarometerBosch *)barometer
{
    self = [super initWithModule:barometer registerId:0x02 format:[[MBLNumericFormatter alloc] initDoubleWithLength:4 isSigned:YES scale:1.0 / 256.0] identifier:@"altitude"];
    if (self) {
...
{
    // Enable cyclic mode with altitude conversion
    uint8_t data[] = { 1, 1 };
